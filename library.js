...
class mutall{
    ...
    //2. The arguments are key/value pairs in the format {[key]:value, ...}
    //It returns the same as result as the method if the return_value is 
    //true; otherwse it returns the generated html
    static async fetch($class, $method, args=null, return_value=true){
        ...
        //
        //Add the method to exceute on the class
        ...
        //pattern: {ok, result, html} where result, if ok, ....
        try{
